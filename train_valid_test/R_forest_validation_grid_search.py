...
# Keep this modest so it runs in a reasonable time
# =========================================================
n_estimators_grid = [100, 200, 300, 400, 500]
max_depth_grid = [6, 8, 10, 12]
min_samples_split_grid = [2, 5, 8, 10]
min_samples_leaf_grid = [1, 2, 4, 6]
...
# =========================================================
results_df.to_csv("train_valid_test/rf_grid_search_results.csv", index=False)
print("\nSaved all grid-search results to rf_grid_search_results.csv")
